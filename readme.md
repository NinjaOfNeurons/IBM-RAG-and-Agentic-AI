# IBM RAG & Agentic AI – Learning Repository

This repository documents my learning journey from the **IBM RAG and Agentic AI course**.

The course explores how to build intelligent AI systems using:
