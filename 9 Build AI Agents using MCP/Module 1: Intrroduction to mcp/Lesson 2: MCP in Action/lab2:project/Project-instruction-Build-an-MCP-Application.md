...
<img src="https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/livCvmEhvl24XOyqA45Kgg/multi-server-client.png" width="75%"><br>
...
<img src="https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/RdA1pvh1vdJyiicgXb8u3g/mcp-adapters.png" width="75%"><br>
...
<img src="https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/LZn04k0bH4Kp1dHKv0kLKQ/react-agent.png" width="75%"><br>
...
```python
    ...
    # This model will power the AI agent's reasoning and responses if the OpenAI model gets rate limited
...
## Author(s)
[Joshua Zhou | Data Scientist @ IBM](https://author.skills.network/instructors/joshua_zhou)
...
|------|--------|--------|---------|
| 2025-09-06 | 1.0 | Joshua Zhou | Initial version created |
| 2025-10-21 | 1.1 | Steve Ryan | ID review / format fixes |
| 2025-10-21 | 1.2 | Leah Hanson | QA reviewed, small IBM style edits |
|   |   |   |   |
